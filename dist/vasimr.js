...
},{"./shadow":2,"./text":3}],2:[function(require,module,exports){
'use strict';
...
function shadow() {
  ...
  props = _lodash2['default'].assign.apply(null, props);

  return new createjs.Shadow(props.color || '#000000', props.left || 1, props.top || 1, props.size || 3);
}
...
function text() {
  ...
  var text = new createjs.Text(props.content, props.font || '16px Arial', props.color || '#000000');
  text.x = props.x;
  text.y = props.y;
  ...
  if (props.shadow) text.shadow = (0, _shadow.shadow)(props.shadow);
...
},{"./shadow":2,"lodash":5}],4:[function(require,module,exports){
'use strict';
...
var _graphicsIndex = require('./graphics/index');

var engine = {
    graphics: _graphicsIndex.graphics
};
...
},{"./graphics/index":1}],5:[function(require,module,exports){
(function (global){
/**
 * @license
